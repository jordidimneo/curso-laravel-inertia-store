...
const visibleFashContainer = ref(true);

const hideFlashMessage = () => {
    setTimeout(() => visibleFashContainer.value = false, 2000)
    return true
}
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <main>
                <transition leave-active-class="transition ease-in duration-1000" leave-from-class="opacity-100"
                    ...
                    <div v-if="visibleFashContainer">
                        <div v-if="$page.props.flash.message && hideFlashMessage()"
                            class="container my-2 bg-purple-400 text-purple-800 px-4 py-3 rounded shadow-sm">
